...
class SkyWarsCommand extends Command implements PluginIdentifiableCommand {
    ...
    public function __construct(SkyWars $plugin) {
        $this->plugin = $plugin;
        parent::__construct("vampirez", "VampireZ commands", \null, ["vz"]);
    }
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args) {
        if(!$sender->hasPermission("vz.cmd")) {
            $sender->sendMessage("§cYou have not permissions to use this command!");
            return;
        }
        if(!isset($args[0])) {
            $sender->sendMessage("§cUsage: §7/vz help");
            return;
        }

        switch ($args[0]) {
            case "help":
                if(!$sender->hasPermission("vz.cmd.help")) {
                    $sender->sendMessage("§cYou have not permissions to use this command!");
                    break;
                }
                $sender->sendMessage("§a> VampireZ commands:\n" .
                    "§7/vz help : Displays list of VampireZ commands\n".
                    "§7/vz create : Create VampireZ arena\n".
                    "§7/vz remove : Remove VampireZ arena\n".
                    "§7/vz set : Set VampireZ arena\n".
                    "§7/vz arenas : Displays list of arenas");

                break;
            case "create":
                if(!$sender->hasPermission("vz.cmd.create")) {
                    $sender->sendMessage("§cYou have not permissions to use this command!");
                    break;
                }
                if(!isset($args[1])) {
                    $sender->sendMessage("§cUsage: §7/vz create <arenaName>");
                    break;
                }
                ...
                break;
            case "remove":
                if(!$sender->hasPermission("vz.cmd.remove")) {
                    $sender->sendMessage("§cYou have not permissions to use this command!");
                    break;
                }
                if(!isset($args[1])) {
                    $sender->sendMessage("§cUsage: §7/vz remove <arenaName>");
                    break;
                }
                if(!isset($this->plugin->arenas[$args[1]])) {
                ...
                break;
            case "set":
                if(!$sender->hasPermission("vz.cmd.set")) {
                    $sender->sendMessage("§cYou have not permissions to use this command!");
                    break;
                }
                ...
                if(!isset($args[1])) {
                    $sender->sendMessage("§cUsage: §7/vz set <arenaName>");
                    break;
                }
                ...
                break;
            case "arenas":
                if(!$sender->hasPermission("vz.cmd.arenas")) {
                    $sender->sendMessage("§cYou have not permissions to use this command!");
                    break;
                }
